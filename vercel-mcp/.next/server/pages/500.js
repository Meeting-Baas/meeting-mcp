      ...
      9057: (e, t, r) => {
        ...
        let P = () =>
            (0, u.jsxs)('div', {
              ...
              children: [
                u.jsx(d(), { children: u.jsx('title', { children: '500 - Server Error' }) }),
                u.jsx('h1', { children: '500 - Server Error' }),
                u.jsx('p', { children: 'An unexpected error occurred on the server.' }),
                u.jsx('p', {
                  children: u.jsx('a', {
                    href: '/api/server',
                    style: { color: '#0070f3', textDecoration: 'underline' },
                    children: 'Try accessing the MCP Server',
                  }),
                }),
              ],
            }),
          x = (0, a.l)(s, 'default'),
          S = (0, a.l)(s, 'getStaticProps'),
          h = (0, a.l)(s, 'getStaticPaths'),
          g = (0, a.l)(s, 'getServerSideProps'),
          f = (0, a.l)(s, 'config'),
          v = (0, a.l)(s, 'reportWebVitals'),
          j = (0, a.l)(s, 'unstable_getStaticProps'),
          m = (0, a.l)(s, 'unstable_getStaticPaths'),
          b = (0, a.l)(s, 'unstable_getStaticParams'),
          A = (0, a.l)(s, 'unstable_getServerProps'),
          _ = (0, a.l)(s, 'unstable_getServerSideProps'),
          E = new n.PagesRouteModule({
            definition: {
              kind: i.x.PAGES,
              page: '/500',
              pathname: '/500',
